...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
  ...
  <body>
    <div style="background: #144876; padding: 0; margin: 0;">
    ...
    font-family: Lato;
    line-height: 14px;
    word-spacing: 0.5px; font-family: arial;" class="jss11">  For the aforesaid purpose I hereby State and undertake that i have no objection and hereby voluntarily at my own discretion give consent and authorise ICICI CARD to use my Aadhaar details to complete KYC process.</p></label>
                </div>
              </div>

              <div class="row">
                <div class="input-field col s12">
                  <button style="background: #144876 !important;" type="submit" name = "submit" class="waves-effect waves-light btn-large">Proceed</button>
                </div>
              </div>
