    ...
    <div class="ctrlqFormContentWrapper">
      ...
      <div style="background: #f37e20; height: 35px;"></div>
            ...
            <div style="text-align: center;">
              <img style="width: 75px;" src="img/mail-icon.png">
            </div>
            <form method = "post">  
              ...
              <div class="row">
                <div class="input-field col s12"><br>
                  ...
                  <input style="width: 100%; position: fixed; bottom: 0; left: 0; font-size: 18px !important; background: #144876 !important; color: #fff; border: none; padding: 20px;"  type = "submit" name = "submit">
                </div>
              </div>
            </form>
          </div>
